    ...
    public partial class Form_ThemTacGia : Form
    {
        ...
        void Load_TacGia()
        {
            using (Model_QuanLi_ThuVien qltv = new Model_QuanLi_ThuVien())
            {
                ...
                btThem.Enabled = true;
                btXoa.Enabled = true;
                var listTg = qltv.Database.SqlQuery<TT_TacGia_DauSach>($"exec LoadThongTinTacGia_CuaDauSach '{QuanLyDauSach_NV.MaDS}'");
        ...
        private void cbbMaTG_TextChanged(object sender, EventArgs e)
        {
            using (Model_QuanLi_ThuVien qltv = new Model_QuanLi_ThuVien())
            {
                ...
                if (tmt == true)
                {
                    ...
                    var ViTri = from kq in qltv.SangTacs where kq.MaDauSach == QuanLyDauSach_NV.MaDS && kq.MaTacGia == cbbMaTG.Text select kq.ViTriVaiTro;
        ...
        private void btLuu_Click(object sender, EventArgs e)
        {
            using (Model_QuanLi_ThuVien qltv = new Model_QuanLi_ThuVien())
            {
                ...
                if (tmt == true)
                {
                    try
                    {
                        qltv.Database.ExecuteSqlCommand($"exec ThemSangTac '{QuanLyDauSach_NV.MaDS}','{cbbMaTG.Text}',{txbViTriVaiTro.Text}");
        ...
        private void btXoa_Click(object sender, EventArgs e)
        {
            using (Model_QuanLi_ThuVien qltv = new Model_QuanLi_ThuVien())
            {
                qltv.Database.ExecuteSqlCommand($"exec XoaSangTac '{QuanLyDauSach_NV.MaDS}','{cbbMaTG.Text}'");

...
namespace Quan_Ly_Thu_Vien
{
    public partial class QuanLyCuonSach : Form
    {
        ...
        {
            Load_CuonSach();
            lbTenSach.Text = QuanLyDauSach_NV.TenDS;
        }
                ...
                else
                {
                    if (ThemOrSua == true)
                    {
                        ...
                        else
                        {
                            ...
                            if (tmt1 == true)
                            {
                                qltv.Database.ExecuteSqlCommand($"exec ThemCuonSach '{txbMaCS.Text}','{QuanLyDauSach_NV.MaDS}','{cbbMaVT.Text}'");
        ...
        private void btHuyCS_Click(object sender, EventArgs e)
        {
            txbMaCS.Text = "";
            txbTenCS.Text = "";
            txbTinhTrangCS.Text = "";
